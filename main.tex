...
\thesistitle{Early Tsunami Warning system (ETC) } % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\degree{master's of information technology} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Rajinder Kaur} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
\addresses{3/99 Montague road pooraka,SA, 5095} % Your address, this is not currently used anywhere in the template, print it elsewhere with \addressname

\subject{Master's project (COMP9710 A,B)} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
...
\group{Ashish kumar , Dilrushie Tennakoon } % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
